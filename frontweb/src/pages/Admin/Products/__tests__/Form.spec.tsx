...
describe('Product Form create tests', () => {
    ...
    test('should show toast and redirect when submit form correctly', async () => {
        ...
        userEvent.type(imgUrlInput, "http://google.com.br");
...
describe('Product Form update tests', () => {
    ...
    test('should show toast and redirect when submit form correctly', async () => {
        ...
        await waitFor(() => {
            ...
            const idsCategories = productResponse.categories.map(ids => String(ids.id));
            expect(formElement).toHaveFormValues({categories: idsCategories});
        })
